...
public enum VoxyGraphicsBackend {
    ...
    public static void initialize() {
        // Minecraft 1.20.6 always owns an OpenGL context. GpuDevice and the
        // public Blaze3D backend selector were introduced in later versions.
        current = OPENGL;
    ...
    public static void applyPreference(RendererMode preference) {
        ...
        activeRenderer = switch (resolvedPreference) {
            case BLAZE3D -> ActiveRenderer.UNAVAILABLE;
