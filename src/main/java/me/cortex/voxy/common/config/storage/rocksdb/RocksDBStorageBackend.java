...
public class RocksDBStorageBackend extends StorageBackend {
    ...
    private static long swizzlePos(long key) {
        ...
        return  (key&(0xFL<<60)) |
                Java17Compat.expand((key>>> 4)&((1L<<24)-1), 0b01010101010101010101010101010101_001001001001001001001001L) |
                Java17Compat.expand((key>>>52)&0xFF,         0b00000000000000000000000000000000_100100100100100100100100L) |
                Java17Compat.expand((key>>>28)&((1L<<24)-1), 0b10101010101010101010101010101010_010010010010010010010010L);
    }
}
