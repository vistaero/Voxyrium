...
public class SaveLoadSystem3 {
    ...
    public static int lin2z(int i) {//y,z,x
        ...
        int y = (i>>10)&0x1F;
        int z = (i>>5)&0x1F;
        return Java17Compat.expand(x,0b1001001001001)|Java17Compat.expand(y,0b10010010010010)|Java17Compat.expand(z,0b100100100100100);

        //zyxzyxzyxzyxzyx
    }

    public static int z2lin(int i) {
        int x = Java17Compat.compress(i, 0b1001001001001);
        int y = Java17Compat.compress(i, 0b10010010010010);
        int z = Java17Compat.compress(i, 0b100100100100100);
        return x|(y<<10)|(z<<5);
    }
